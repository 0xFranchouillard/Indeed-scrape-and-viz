...
def home():
    ...
    graphNote(collection)
    graphScore(collection)
    graphHiring(collection)
    graphNoteRep(collection)
...
def graphNoteRep(collection):
    ...
    plt.savefig("static/rep_note.png")
